...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    <head>
        ...
        <meta name="description" content="Katalog Menu Bergizi - E-SPPG POLRI Cengkareng">

        <title>Katalog Menu Bergizi — E-SPPG POLRI Cengkareng</title>
        ...
        <main>
            <section class="bg-[#17382a] py-16 sm:py-20">
                <div class="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
                    ...
                    <h1 class="text-4xl font-bold tracking-[-0.045em] text-white sm:text-5xl">Menu Bergizi</h1>
                    <p class="mt-4 max-w-2xl text-base leading-7 text-white/80">Daftar menu bergizi yang tersedia di E-SPPG POLRI Cengkareng.</p>
                </div>
            </section>
                ...
                <div class="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
                    @if ($items->isEmpty())
                        <div class="rounded-2xl border border-dashed border-[#17382a]/15 py-20 text-center">
                            <p class="text-base text-[#60786c]">Belum ada data menu bergizi.</p>
                        </div>
                    @else
        ...
        <footer class="bg-[#123326] text-white">
            <div class="mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:px-8 md:grid-cols-2 md:items-end lg:px-10">
                ...
                <div class="flex flex-col gap-5 md:items-end">
                    <p class="text-xs tracking-wide text-white/55">&copy; Copyright E-SPPG POLRI Cengkareng 2025 All rights reserved</p>
                </div>
            </div>
        </footer>
